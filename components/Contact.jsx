      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          >
            {[
              ...
              },
              {
                ...
                color: "bg-blue-500",
                label: "Email",
                value: "shakhawathossen188@gmail.com",
              ...
              >
                <div
                  className={`w-12 h-12 ${item.color} rounded-xl flex items-center justify-center text-white text-xl shadow-lg shadow-${item.color.split("-")[1]}-500/20`}
                >
                  {item.icon}
                </div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="lg:col-span-2 bg-white dark:bg-[#161B22] p-8 sm:p-10 rounded-4xl border border-gray-100 dark:border-gray-800 shadow-xl"
          >
